...
public class PageAccount extends AppCompatActivity {
    ...
    private void UpdatePassword() {
        ...
        CallJson jc = new CallJson(PageAccount.this);
        ...
        jc.SendRequest(s,"update_password", param, new JsonCallbacks() {
            ...
            public void onPostSuceess(String json, String method) throws JSONException {
                UserUtil.ShowMsg("Password Updated !!",PageAccount.this);
            }
            @Override
    ...
    private void UpdateData() {
        ...
        jc.SendRequest(s,"update_user", param, new JsonCallbacks() {
            @Override
            public void onPostSuceess(String json, String method) throws JSONException {
                UserUtil.ShowMsg("Details Updated !!",PageAccount.this);
                ...
                try {
                    ...
                    if (obj.length() != 1) {
                        ...
                        sd.setAddress_line_1(obj.getString("address_line_1"));
                        sd.setAddress_line_2(obj.getString("address_line_2"));
                        SessionManage.SetCustomerSessions(getApplicationContext(), sd);
                        finish();
                    }
                } catch (JSONException e) {
                    Utility.ShowMEssage(PageAccount.this, "Invalid OTP !");
                    e.printStackTrace();
                }
            }
            @Override
    ...
    private void BindDate() {
        ...
        txdob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(PageAccount.this,
